 ...
 */
public class RosesStageModelTool extends GameStageModel {
    ...
    public RosesStageModelTool(String name, Model model) {
        super(name, model);
        bluePawnsToPlay = 26;
        redPawnsToPlay = 26;
...
//    }
    ...
    public int countZoneSize(int n, int m, int color, boolean[][] visited) {
        int size = 0;
