...
public class RosesDecider extends Decider {
    ...
    public ActionList decide() {
        ...
        for(int i=0;i<5;i++) {
            ...
            if (p != null) {
                // get the valid cells
                List<Point> valid = board.computeValidCells(model.getIdPlayer());
                if (valid.size() != 0) {
        ...
        ActionList actions = ActionFactory.generatePutInContainer(control, model, pawn, "RoseBoard", rowDest, colDest, AnimationTypes.MOVE_LINEARPROP, 10);
